...
/** LoadPLN3 : Loads an ANSTO PLN Hdf and linked event file into a workspace.
...
*/
class DLLExport LoadPLN3 : public API::IFileLoader<Kernel::NexusDescriptor> {
...
protected:
  ...
  void loadParameters(NeXus::NXEntry &entry, API::LogManager &logm);
  void loadEnvironParameters(NeXus::NXEntry &entry, API::LogManager &logm);
