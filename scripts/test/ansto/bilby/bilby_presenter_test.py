...
"""
The objective of the test is to confirm that: 
1. The presenter correctly builds the state data from the table.
2. Invokes the batch processor correctly.

The 'mock' objects are:
a. View based on BilbyBatchReductionGui
b. 
"""
...
class BilbyPresenterTest(unittest.TestCase):
    def setUp(self):
